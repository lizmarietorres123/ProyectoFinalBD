...
public class CrearDiagnostico extends JDialog {
    ...
    private void mostrarDetallesEnfermedad() {
        if(cbxEnfermedad.getSelectedIndex() > 0) {
            ...
            if(enfermedad != null) {
                ...
                detalles.append("En Vigilancia: ").append(enfermedad.isVigilancia() ? "S�" : "No").append("\n");
                detalles.append("S�ntomas: ").append(enfermedad.getSintomas()).append("\n");
    ...
    private void crearDiagnostico() {
        if(txtDescripcion.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Debe ingresar una descripci�n.", "Campo Requerido", JOptionPane.WARNING_MESSAGE);
            return;
        }
