...
public class ListarDetalleAnalisis extends JDialog {
    ...
    public ListarDetalleAnalisis() {
        this(false);
    }

    public ListarDetalleAnalisis(boolean soloLectura) {
        this.soloLectura = soloLectura;
        setTitle(soloLectura ? "Listado General de Detalles de Análisis (Solo Lectura)" : "Listado General de Detalles de Análisis");
        inicializarVentana();
    }

    public ListarDetalleAnalisis(Consulta consulta) {
        this(true);
        this.consultaEspecifica = consulta;
        setTitle("Detalles de Análisis de la Consulta");
        cargarTablaDetalles();
    }
    ...
    private void inicializarVentana() {
        ...
        txtBuscarAnalisis.setBounds(515, 26, 370, 22);
        ...
        String[] columnas = {"ID Consulta", "Análisis", "Paciente", "Enfermera", "Fecha", "Resultado", "Estado", "Observaciones"};
    ...
    private void abrirDetalle() {
        ...
        DetalleAnalisis detalle = listaDetallesVisibles.get(selectedRow);
        MostrarDetalleAnalisis ventanaDetalle = new MostrarDetalleAnalisis(detalle);
